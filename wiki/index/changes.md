...
|---|---|---|---|
| [`2026-09-23-nginx-machine-defaults`](../../openspec/changes/2026-09-23-nginx-machine-defaults/proposal.md) | **в работе** | — | Настройки nginx, которых на машине может быть только одна копия, ставит роль |
